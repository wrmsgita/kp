...
@php
$judul = ['Id','Nama','No. KK','Email','Action'];
@endphp
                  ...
                  <td>
                    <div class="btn-group">
                      ...
                      <div class="dropdown-menu" aria-labelledby="dropdownMenuReference">
                        <a class="dropdown-item" href="{{ route('pengguna.show', $u ->id) }}" value=""><i
                            class="fas fa-eye mr-1"></i>Detail</a>
                        <a class="dropdown-item" href="{{route('pengguna.edit', $u ->id)}}"><i
                            class="fas fa-edit mr-1"></i>Ganti Role</a>
                        <a href="#" class="dropdown-item hapus" link="pengguna" hapus-id="{{$u ->id}}"><i
