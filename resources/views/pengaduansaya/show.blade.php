...
$ustadz =\App\Pengurus::where('id', $pengaduan ->ustadz_id)->first();

@endphp
@section('content')
<div class="row animated fadeInRight">
    <div class="col-md-12"><a href="{{url('pengaduan1')}}"
            class="btn btn-outline-danger btn-rounded btn-block z-depth-0 my-4 waves-effect" type="submit">Kembali</a>
    </div>
</div>
<div class="row">
        ...
        <div class="card">
            ...
            <div class="card-body px-lg-5">
                ...
                <form class="text-center" style="color: #757575;" action="#!">
                    ...
                    <!-- E-mai -->
                    <div class="md-form">
                        <input value="{{$nama2 ->name}}" type="email" id="materialSubscriptionFormEmail"
                            class="form-control" disabled>
                    ...
                    <div class="md-form">
                        <input value="{{$ustadz ->nama}}" type="email" id="materialSubscriptionFormEmail"
                            class="form-control" disabled>
                        <label for="materialSubscriptionFormEmail">Ustadz</label>
                    </div>

                    <div class="md-form mt-4">
                        <textarea name="jawaban" id="materialContactFormMessage" class="form-control md-textarea"
                            rows="3" disabled>{{$pengaduan ->jawaban}}</textarea>
    ...
    <div class="col-md-6 animated fadeInRight">
        <div class="card">
            ...
            <div class="card-body px-lg-5">
                ...
                <div class="md-form">
                    <img src="{{asset('img')}}/{{$pengaduan ->bukti}}" class="img-fluid img-thumbnail z-depth-2"
