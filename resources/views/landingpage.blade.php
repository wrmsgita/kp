    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top scrolling-navbar">
      <div class="container">
        <a class="navbar-brand" href="#">
          <img src="{{asset('img/logopa.png')}}" height="30" class="d-inline-block align-top" alt="mdb logo">
        </a>
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-md-12 mb-4 white-text text-center">
              <h2 class="h2-reponsive white-text text-uppercase font-weight-bold mb-0 pt-md-5 pt-5 wow fadeInDown"
                data-wow-delay="0.3s"><strong>Apa Itu Pengaduan!?</strong></h2>
              <hr class="hr-light my-4 wow fadeInDown" data-wow-delay="0.5s">
              <h5 class="h5-reponsive mb-4 white-text wow fadeInDown" data-wow-delay="0.4s">
                <p>Pengaduan adalah pemberitahuan yang disertai permintaan oleh pihak yang berkepentingan kepada ustadz
                  yang berwenang untuk menindak menurut Hukum, terhadap seseorang yang telah melakukan Tindak Pidana
                  Aduan yang merugikan.

                </p>
              </h5>
              <a href="{{url('login')}}" class="btn btn-outline-white wow fadeInDown animated tada infinite delay-2s"
                data-wow-delay="0.4s">Login </a>
              <a href="{{url('register')}}" class="btn btn-outline-white wow fadeInDown animated tada infinite delay-3s"
                data-wow-delay="0.4s">Register</a>
            </div>
            <!--Grid column-->
          </div>
          <!--Grid row-->
