...
->select('santri.*', 'santri.id', 'santri.nokk', 'santri.nama', 'asal.nama AS asal', 'kategori.nama AS kategori',
    ...
    {{-- <table border="0" width="100%">
      <tr>
        ...
        <td width="85%" align="center">
          <h1>PONPES TAHFIDZ PRENEUR YBM PLN</h1>
          <h2>Cibeureum, Kec. Cisarua, Bogor, Jawa Barat 16750</h2>
        </td>
      </tr>
    </table> --}}
    <hr>
