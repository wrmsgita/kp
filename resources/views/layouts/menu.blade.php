...
<header>
  ...
  <nav class="navbar fixed-top navbar-toggleable-md navbar-expand-lg scrolling-navbar double-nav ">
    ...
    <ul class="nav navbar-nav nav-flex-icons ml-auto">
      {{-- <li class="nav-item">
        <a class="nav-link"><i class="fas fa-envelope"></i> <span class="clearfix d-none d-sm-inline-block"></span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link"><i class="fas fa-comments"></i> <span class="clearfix d-none d-sm-inline-block"></span></a>
      </li>
      --}}
      ...
      <li class="nav-item dropdown avatar dropdown">
        <a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink-55" data-toggle="dropdown" aria-haspopup="true"
          ...
          <img src="{{asset('img')}}/{{ Auth::user()->foto}}" width="35px" height="35px"
        ...
        <div class="dropdown-menu dropdown-danger dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink"
          style="">
